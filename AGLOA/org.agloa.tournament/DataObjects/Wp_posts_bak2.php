<?php
/**
 * Table Definition for wp_posts_bak2
 */
require_once 'DB/DataObject.php';

class Wp_posts_bak2 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'wp_posts_bak2';       // table name
    ...
    public $post_password;                  // varchar(20) not_null
