<?php
/**
 * Table Definition for civicrm_mailing
 */
require_once 'DB/DataObject.php';

class Civicrm_mailing extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'civicrm_mailing';     // table name
    ...
    public $template_type;                  // varchar(64) not_null default_traditional
