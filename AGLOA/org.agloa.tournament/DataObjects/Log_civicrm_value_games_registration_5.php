<?php
/**
 * Table Definition for log_civicrm_value_games_registration_5
 */
require_once 'DB/DataObject.php';

class Log_civicrm_value_games_registration_5 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'log_civicrm_value_games_registration_5';    // table name
    ...
    public $scheduling_group_19;            // varchar(2)
    public $geocode_19;                     // varchar(2)
