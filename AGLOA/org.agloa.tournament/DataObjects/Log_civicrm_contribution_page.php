<?php
/**
 * Table Definition for log_civicrm_contribution_page
 */
require_once 'DB/DataObject.php';

class Log_civicrm_contribution_page extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'log_civicrm_contribution_page';    // table name
    ...
    public $is_for_organization;            // tinyint(1)
    public $for_organization;               // text
    ...
    public $adjust_recur_start_date;        // tinyint(1)
