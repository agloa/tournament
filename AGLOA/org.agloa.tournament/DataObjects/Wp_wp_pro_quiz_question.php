<?php
/**
 * Table Definition for wp_wp_pro_quiz_question
 */
require_once 'DB/DataObject.php';

class Wp_wp_pro_quiz_question extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'wp_wp_pro_quiz_question';    // table name
    public $id;                             // int(4) primary_key not_null
    public $quiz_id;                        // int(4) not_null
    public $online;                         // tinyint(1) not_null unsigned
    ...
    public $answer_points_diff_modus_activated;   // tinyint(1) not_null unsigned
    public $disable_correct;                // tinyint(1) not_null unsigned
    public $matrix_sort_answer_criteria_width;   // tinyint(1) not_null unsigned
