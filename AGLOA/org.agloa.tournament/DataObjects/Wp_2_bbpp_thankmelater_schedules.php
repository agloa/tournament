<?php
/**
 * Table Definition for wp_2_bbpp_thankmelater_schedules
 */
require_once 'DB/DataObject.php';

class Wp_2_bbpp_thankmelater_schedules extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'wp_2_bbpp_thankmelater_schedules';    // table name
