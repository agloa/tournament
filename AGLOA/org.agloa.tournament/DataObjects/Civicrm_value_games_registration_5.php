<?php
/**
 * Table Definition for civicrm_value_games_registration_5
 */
require_once 'DB/DataObject.php';

class Civicrm_value_games_registration_5 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'civicrm_value_games_registration_5';    // table name
