<?php
/**
 * Table Definition for wp_bbpp_thankmelater_messages
 */
require_once 'DB/DataObject.php';

class Wp_bbpp_thankmelater_messages extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'wp_bbpp_thankmelater_messages';    // table name
