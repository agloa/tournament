<?php
/**
 * Table Definition for log_civicrm_value_team_data_7
 */
require_once 'DB/DataObject.php';

class Log_civicrm_value_team_data_7 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'log_civicrm_value_team_data_7';    // table name
