<?php
/**
 * Table Definition for agloa_linguishtik_sections
 */
require_once 'DB/DataObject.php';

class Agloa_linguishtik_sections extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'agloa_linguishtik_sections';    // table name
