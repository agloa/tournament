<?php
/**
 * Table Definition for civicrm_value_team_data_7
 */
require_once 'DB/DataObject.php';

class Civicrm_value_team_data_7 extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'civicrm_value_team_data_7';    // table name
