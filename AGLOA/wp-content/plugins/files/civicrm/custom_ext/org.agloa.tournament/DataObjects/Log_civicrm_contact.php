<?php
/**
 * Table Definition for log_civicrm_contact
 */
require_once 'DB/DataObject.php';

class Log_civicrm_contact extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'log_civicrm_contact';    // table name
