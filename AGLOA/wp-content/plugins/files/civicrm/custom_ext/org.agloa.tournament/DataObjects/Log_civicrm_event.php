<?php
/**
 * Table Definition for log_civicrm_event
 */
require_once 'DB/DataObject.php';

class Log_civicrm_event extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'log_civicrm_event';    // table name
