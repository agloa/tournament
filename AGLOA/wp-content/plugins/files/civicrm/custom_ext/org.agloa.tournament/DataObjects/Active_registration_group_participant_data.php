<?php
/**
 * Table Definition for active_registration_group_participant_data
 */
require_once 'DB/DataObject.php';

class Active_registration_group_participant_data extends DB_DataObject 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'active_registration_group_participant_data';    // table name
